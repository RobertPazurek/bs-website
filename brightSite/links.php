<?php
/*
Template Name: Bright Site - Einzelseite: Links
*/
?>
...
<div class="content">
  ...
  <?php masterslider(2); ?>  
    <div id="singlepageMain">
		...
		<?php endif; ?>
		<br>
		<a href="http://www.boulder-project.de/#links"><img class="link" src="<?php bloginfo('template_directory'); ?>/images/backButton3.png"></a>
		</div>
	</div>
</div>
