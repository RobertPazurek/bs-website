<?php
/*
Template Name: Bright Site - Einzelseite: Yoga 
*/
?>
...
<div class="content">
	...
	<div id="singlepageMain">
		<img class="siteimageTop" alt="news bild" src="<?php bloginfo('template_directory'); ?>/images/kokon.jpg" />
		<h2 class="headline1">yoga</h2>
